...
class UserAdmin(BaseUserAdmin):
    # 表示するフィールドのセットアップ
    list_display = ('email', 'name', 'get_review_average', 'review_count', 'is_staff', 'is_active', 'created_at', 'profile_image')
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('name', 'age', 'sex', 'contact_address', 'bio', 'review_count', 'review_sum', 'profile_image')}),
